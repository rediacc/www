    ...
    <footer id="footer" className="footer" role="contentinfo">
        <div className="footer-container">
          ...
          <div className="footer-column">
            ...
            <a href={`/${currentLang}/contact`} className="footer-link">{t('footer.organizationLinks.aboutUs')}</a>
            <a href={`/${currentLang}/team`} className="footer-link">{t('footer.organizationLinks.team')}</a>
            <a href={`/${currentLang}/contact`} className="footer-link">{t('footer.organizationLinks.contact')}</a>
          </div>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-left">
            ...
            <div className="footer-social">
              ...
              <a href="https://www.linkedin.com/organization/rediacc/about" className="footer-social-link" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
